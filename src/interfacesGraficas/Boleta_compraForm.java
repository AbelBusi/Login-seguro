 ...
 * @author cesar
 */
public class Boleta_compraForm extends javax.swing.JFrame {

    /**
     * Creates new form Boleta_compraForm
     */
    public Boleta_compraForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("RUC 20548658924");

        jLabel7.setText("SUPERMERCADO PERUANO S . A.");

        jLabel8.setText("Av.                Nro            Chiclayo");

        jLabel9.setText("Chiclayo - Lambayeque");
        ...
        jLabel13.setText("Numero de Boleta:");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Descripcion", "Cantidad", "Precio Unit", "Total"
            }
        ) {
        ...
        jLabel4.setText("Num Caja");

        jLabel5.setText("Nombre Del Cajero");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Boleta_compraForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Boleta_compraForm().setVisible(true);
            }
        });
    }
